...
\begin{figure}[H]
\centering
\includegraphics[width=6cm,height=6cm]{figures/9chan.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=6cm,height=6cm]{figures/10chan.png}
\caption{IDE Spyder}
\label{akhir}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=6cm,height=6cm]{figures/11chan.png}
