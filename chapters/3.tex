...
\begin{itemize}
	\item 
		...
		\lstinputlisting[firstline=58, lastline=64]{src/1174075.py}
	\item 
        \lstinputlisting[firstline=67, lastline=76]{src/1174075.py}
	\item 
        \lstinputlisting[firstline=79, lastline=84]{src/1174075.py}
	\item 
        \lstinputlisting[firstline=87, lastline=91]{src/1174075.py}
	\item 
        \lstinputlisting[firstline=94, lastline=100]{src/1174075.py}
	\item 
        \lstinputlisting[firstline=103, lastline=109]{src/1174075.py}
	\item 
        \lstinputlisting[firstline=112, lastline=117]{src/1174075.py}
	\item 
	    \lstinputlisting[firstline=120, lastline=125]{src/1174075.py}
	\item 
        \lstinputlisting[firstline=128, lastline=141]{src/1174075.py}
...
\item buat fungsi program dengan input variabel NPM dan melakukan print nomor npm satu persatu kebawah.
\lstinputlisting[firstline=123, lastline=128]{src/1174070.py}
...
\begin{enumerate}
    ...
    \lstinputlisting[firstline=8, lastline=13]{src/1174086.py}

    Fungsi input digunakan untuk menerima baris input dari user dan mengembalikannya dalam string.
    \lstinputlisting[firstline=14, lastline=19]{src/1174086.py}

    Fungsi kembalian atau yang sering disebut dengan return merupakan fungsi yang mengembalikan nilai.
    \lstinputlisting[firstline=20, lastline=27]{src/1174086.py}

    \item Apa itu paket dan cara pemanggilan paket atau library dengan contoh kode
    program lainnya.
    Untuk memudahkan dalam pemanggilan fungsi yang di butuhkan, agar dapat dipanggil berulang.
    Cara pemanggilannya
    \lstinputlisting[firstline=30, lastline=31]{src/1174086.py}
    ...
    \lstinputlisting[firstline=32, lastline=56]{src/1174086.py}
    ...
    \end{itemize}
    \lstinputlisting[firstline=57, lastline=62]{src/1174086.py}

    \item Jelaskan dengan contoh pemakaian paket dengan perintah from kalkulator im-
    port Penambahan disertai dengan contoh kode lainnya.
    Penggunaan paket from namafile import, itu berfungsi untuk memanggil file dan fungsinya
    \lstinputlisting[firstline=61, lastline=62]{src/1174086.py}
    ...
    \item Jelaskan dengan contoh kodenya, pemakaian paket kelas apabila le library ada
    di dalam folder.
    \lstinputlisting[firstline=70, lastline=70]{src/1174086.py}
...
\begin{enumerate}
    ...
    bintang untuk NPM mod 3=0, tanda pagar untuk NPM mod 3 =1, tanda plus
    untuk NPM mod3=2.
    \lstinputlisting[firstline=71, lastline=121]{src/1174086.py}

    \item Buatlah fungsi dengan inputan variabel berupa NPM. kemudian dengan meng-
    gunakan perulangan mengeluarkan print output sebanyak dua dijit belakang
    NPM.
    \lstinputlisting[firstline=122, lastline=130]{src/1174086.py}

    \item Buatlah fungsi dengan dengan input variabel string bernama NPM dan beri
    luaran output dengan perulangan berupa tiga karakter belakang dari NPM se-
    banyak penjumlahan tiga dijit tersebut.
    \lstinputlisting[firstline=131, lastline=142]{src/1174086.py}

    \item Buatlah fungsi hello word dengan input variabel string bernama NPM dan
    beri luaran output berupa digit ketiga dari belakang dari variabel NPM meng-
    gunakan akses langsung manipulasi string pada baris ketiga dari variabel NPM.
    \lstinputlisting[firstline=143, lastline=150]{src/1174086.py}

    \item buat fungsi program dengan input variabel NPM dan melakukan print nomor npm satu persatu kebawah.
    \lstinputlisting[firstline=151, lastline=157]{src/1174086.py}

    \item Buatlah fungsi dengan inputan variabel NPM, didalamnya melakukan penjum-
    lahan dari seluruh dijit NPM tersebut, wajib menggunakan perulangan dan
    atau kondisi.
    \lstinputlisting[firstline=158, lastline=166]{src/1174086.py}

    \item Buatlah fungsi dengan inputan variabel NPM, didalamnya melakukan melakukan
    perkalian dari seluruh dijit NPM tersebut, wajib menggunakan perulangan dan
    atau kondisi.
    \lstinputlisting[firstline=167, lastline=175]{src/1174086.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit genap saja. wajib menggunakan perulangan dan atau kondisi.
    \lstinputlisting[firstline=176, lastline=183]{src/1174086.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit ganjil saja. wajib menggunakan perulangan dan atau kondisi.
    \lstinputlisting[firstline=184, lastline=191]{src/1174086.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit yang termasuk bilangan prima saja. wajib menggunakan perulangan
    dan atau kondisi.
    \lstinputlisting[firstline=192, lastline=207]{src/1174086.py}
...
kemudian run kembali aplikasinya
berikut contoh Penggunaan fungsi try dan exception
\lstinputlisting[firstline=64, lastline=69]{src/1174086.py}
...
\begin{enumerate}
    ...
    \lstinputlisting[firstline=8, lastline=14]{src/1174074/1174074.py}
   ...
   Paket atau library adalah kumpulan fungsi untuk memudahkan pemrogram membuat program dan tidak perlu mengakses langsung   		sistem komputer untuk memprogram.
    Cara pemanggilannya
    \lstinputlisting[firstline=16, lastline=20]{src/1174074.py}
    ...
    \lstinputlisting[firstline=22, lastline=37]{src/1174074.py}
   ...
   Berikut ini adalah cara pemanggilan library kelas dari instansi dan pemakaiannya.Nama dari Library kelasnya adalah pakan dari file pakan.py
    \lstinputlisting[firstline=39, lastline=45]{src/1174074.py}

    \item Jelaskan dengan contoh pemakaian paket dengan perintah from kalkulator im-
    port Penambahan disertai dengan contoh kode lainnya.
   Berikut ini adalah pemakaian paket fungsi apabila file library ada di dalam folder.
    \lstinputlisting[firstline=47, lastline=50]{src/1174074.py}

    \item Jelaskan dengan contoh kodenya, pemakaian paket fungsi apabila le library
    ada di dalam folder.
    Pemakaian paket adalah perkumpulan fungsi-fungsi. contoh kodenya adalah sebagai berikut :
    \lstinputlisting[firstline=52, lastline=66]{src/1174074.py}

    \item Jelaskan dengan contoh kodenya, pemakaian paket kelas apabila le library ada
    di dalam folder.
    \lstinputlisting[firstline=68 lastline=74]{src/1174074.py}
...
\begin{enumerate}
    ...
    bintang untuk NPM mod 3=0, tanda pagar untuk NPM mod 3 =1, tanda plus
    untuk NPM mod3=2.
    \lstinputlisting[firstline=78, lastline=115]{src/1174074.py}

    \item Buatlah fungsi dengan inputan variabel berupa NPM. kemudian dengan meng-
    gunakan perulangan mengeluarkan print output sebanyak dua dijit belakang
    NPM.
    \lstinputlisting[firstline=118, lastline=126]{src/1174074.py}

    \item Buatlah fungsi dengan dengan input variabel string bernama NPM dan beri
    luaran output dengan perulangan berupa tiga karakter belakang dari NPM se-
    banyak penjumlahan tiga dijit tersebut.
    \lstinputlisting[firstline=128, lastline=137]{src/1174074.py}

    \item Buatlah fungsi hello word dengan input variabel string bernama NPM dan
    beri luaran output berupa digit ketiga dari belakang dari variabel NPM meng-
    gunakan akses langsung manipulasi string pada baris ketiga dari variabel NPM.
    \lstinputlisting[firstline=139, lastline=144]{src/1174074.py}

    \item buat fungsi program dengan input variabel NPM dan melakukan print nomor npm satu persatu kebawah.
    \lstinputlisting[firstline=146, lastline=152]{src/1174074.py}

    \item Buatlah fungsi dengan inputan variabel NPM, didalamnya melakukan penjum-
    lahan dari seluruh dijit NPM tersebut, wajib menggunakan perulangan dan
    atau kondisi.
    \lstinputlisting[firstline=154, lastline=163]{src/1174074.py}

    \item Buatlah fungsi dengan inputan variabel NPM, didalamnya melakukan melakukan
    perkalian dari seluruh dijit NPM tersebut, wajib menggunakan perulangan dan
    atau kondisi.
    \lstinputlisting[firstline=165, lastline=174]{src/1174074.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit genap saja. wajib menggunakan perulangan dan atau kondisi.
    \lstinputlisting[firstline=176, lastline=184]{src/1174074.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit ganjil saja. wajib menggunakan perulangan dan atau kondisi.
    \lstinputlisting[firstline=186, lastline=193]{src/1174074.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit yang termasuk bilangan prima saja. wajib menggunakan perulangan
    dan atau kondisi.
    \lstinputlisting[firstline=196, lastline=221]{src/1174074.py}

    \item Buatlah satu library yang berisi fungsi-fungsi dari nomor diatas dengan nama
    le 3lib.py dan berikan contoh cara pemanggilannya pada le main.py.
    \lstinputlisting[firstline=7, lastline=44]{src/main.py}

    \item Buatlah satu library class dengan nama le kelas3lib.py yang merupakan mod-
    ikasi dari fungsi-fungsi nomor diatas dan berikan contoh cara pemanggilannya
    pada le main.py.
    \lstinputlisting[firstline=45, lastline=61]{src/main.py}
...
berikut contoh Penggunaan fungsi try dan exception
\lstinputlisting[firstline=219, lastline=226]{src/1174074.py}
...
\lstinputlisting[firstline=2, lastline=18]{src/1174067/1174067PT.py}

\item paket atau library merupakan file yang berisi kode yang dipanggil menggunkana perintah "import". contoh :
\lstinputlisting[firstline=20, lastline=22]{src/1174067/1174067PT.py}
...
\lstinputlisting[firstline=25, lastline=37]{src/1174067/1174067PT.py}
...
\begin{enumerate}
\item jawaban :
\lstinputlisting[firstline=1, lastline=35]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=36, lastline=45]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=46, lastline=56]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=47, lastline=62]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=63, lastline=70]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=71, lastline=81]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=82, lastline=92]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=93, lastline=102]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=103, lastline=111]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=112, lastline=130]{src/1174067/3lib.py}

\item jawaban :
\lstinputlisting[firstline=1, lastline=3]{src/1174067/main.py}

\item jawaban :
\lstinputlisting[firstline=4, lastline=8]{src/1174067/main.py}
\end{enumerate}
...
\begin{enumerate}
    ...
    \lstinputlisting[firstline=85, lastline=88]{src/1174072/1174072.py}
    ...
    Fungsi dapat membaca parameter, parameter adalah nilai yang disediakan kepada fungsi, dimana nilai ini akan menentukan output yang akan dihasilkan fungsi. Parameter dikirim dalam tanda kurung saat pemanggilan fungsi.Statemen return digunakan untuk keluar dari fungsi. return digunakan untuk mengembalikan nilai semula.
      \lstinputlisting[firstline=91, lastline=92]{src/1174072/1174072.py}

    \item Apa itu paket dan cara pemanggilan paket atau library dengan contoh kode
    program lainnya.
    dengan adanya paket dapat memudahkan dalam proses pemanggilan, agar dapat dipanggil berulang.
    Cara pemanggilannya
    \lstinputlisting[firstline=100, lastline=101]{src/1174072/1174072.py}
...
\lstinputlisting[caption = Contoh penggunaan kelas di python., firstline=104, lastline=124]{src/1174072/1174072.py}
...
\lstinputlisting[caption = Contoh penggunaan Objek di python., firstline=117, lastline=118]{src/1174072/1174072.py}
\item Atribut adalah data anggota (variabel kelas dan variabel contoh) dan metode, diakses melalui notasi titik.
    \lstinputlisting[caption = Contoh penggunaan Atribut di python., firstline=105, lastline=105]{src/1174072/1174072.py}
\item Metode adalah fungsi yang didefinisikan di dalam suatu kelas.
     \lstinputlisting[caption = Contoh penggunaan Metode di python., firstline=112, lastline=115]{src/1174072/1174072.py}
    \end{itemize}
    ...
    \end{itemize}
  \lstinputlisting[firstline=125, lastline=135]{src/1174072/1174072.py}
    ...
    \lstinputlisting[firstline=137, lastline=140]{src/1174072/1174072.py}

    \item Jelaskan dengan contoh kodenya, pemakaian paket fungsi apabila le library
    ada di dalam folder.
    Pemakaian paket gabungan atau kumpulan fungsi-fungsi dalam satu hasil yang dibuat. contoh kodenya adalah sebagai berikut :
    \lstinputlisting[firstline=142, lastline=144]{src/1174072/1174072.py}

    \item Jelaskan dengan contoh kodenya, pemakaian paket kelas apabila le library ada
    di dalam folder.
    \lstinputlisting[firstline=160, lastline=168]{src/1174072/1174072.py}
...
\begin{enumerate}
    ...
    bintang untuk NPM mod 3=0, tanda pagar untuk NPM mod 3 =1, tanda plus
    untuk NPM mod3=2.
    \lstinputlisting[firstline=172, lastline=205]{src/1174072/1174072.py}

    \item Buatlah fungsi dengan inputan variabel berupa NPM. kemudian dengan meng-
    gunakan perulangan mengeluarkan print output sebanyak dua dijit belakang
    NPM.
    \lstinputlisting[firstline=208, lastline=215]{src/1174072/1174072.py}

    \item Buatlah fungsi dengan dengan input variabel string bernama NPM dan beri
    luaran output dengan perulangan berupa tiga karakter belakang dari NPM se-
    banyak penjumlahan tiga dijit tersebut.
    \lstinputlisting[firstline=218, lastline=226]{src/1174072/1174072.py}

    \item Buatlah fungsi hello word dengan input variabel string bernama NPM dan
    beri luaran output berupa digit ketiga dari belakang dari variabel NPM meng-
    gunakan akses langsung manipulasi string pada baris ketiga dari variabel NPM.
    \lstinputlisting[firstline=229, lastline=233]{src/1174072/1174072.py}

    \item buat fungsi program dengan input variabel NPM dan melakukan print nomor npm satu persatu kebawah.
    \lstinputlisting[firstline=236, lastline=241]{src/1174072/1174072.py}

    \item Buatlah fungsi dengan inputan variabel NPM, didalamnya melakukan penjum-
    lahan dari seluruh dijit NPM tersebut, wajib menggunakan perulangan dan
    atau kondisi.
    \lstinputlisting[firstline=244, lastline=252]{src/1174072/1174072.py}

    \item Buatlah fungsi dengan inputan variabel NPM, didalamnya melakukan melakukan
    perkalian dari seluruh dijit NPM tersebut, wajib menggunakan perulangan dan
    atau kondisi.
    \lstinputlisting[firstline=255, lastline=263]{src/1174072/1174072.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit genap saja. wajib menggunakan perulangan dan atau kondisi.
    \lstinputlisting[firstline=266, lastline=273]{src/1174072/1174072.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit ganjil saja. wajib menggunakan perulangan dan atau kondisi.
    \lstinputlisting[firstline=276, lastline=282]{src/1174072/1174072.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit yang termasuk bilangan prima saja. wajib menggunakan perulangan
    dan atau kondisi.
    \lstinputlisting[firstline=285, lastline=301]{src/1174072/1174072.py}

    \item Buatlah satu library yang berisi fungsi-fungsi dari nomor diatas dengan nama
    le 3lib.py dan berikan contoh cara pemanggilannya pada le main.py.
    \lstinputlisting[firstline=35, lastline=49]{src/1174072/main_1174072.py}

    \item Buatlah satu library class dengan nama le kelas3lib.py yang merupakan mod-
    ikasi dari fungsi-fungsi nomor diatas dan berikan contoh cara pemanggilannya
    pada le main.py.
    \lstinputlisting[firstline=50, lastline=65]{src/1174072/main_1174072.py}
...
kemudian run kembali aplikasinya
berikut contoh Penggunaan fungsi try dan exception
\lstinputlisting[firstline=309, lastline=315]{src/1174072/1174072.py}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}
	\item Jawaban soal No. 1
	\lstinputlisting[caption = Jawaban soal No. 1 Ketrampilan Pemrograman., firstline=10, lastline=44]{src/1174080.py}
	
	\item Jawaban soal No. 2
	\lstinputlisting[caption = Jawaban soal No. 2 Ketrampilan Pemrograman., firstline=46, lastline=54]{src/1174080.py}
	
	\item Jawaban soal No. 3
	\lstinputlisting[caption = Jawaban soal No. 3 Ketrampilan Pemrograman., firstline=56, lastline=65]{src/1174080.py}
	
	\item Jawaban soal No. 4
	\lstinputlisting[caption = Jawaban soal No. 4 Ketrampilan Pemrograman., firstline=67, lastline=72]{src/1174080.py}
	
	\item Jawaban soal No. 5
	\lstinputlisting[caption = Jawaban soal No. 5 Ketrampilan Pemrograman., firstline=74, lastline=78]{src/1174080.py}
	
	\item Jawaban soal No. 6
	\lstinputlisting[caption = Jawaban soal No. 6 Ketrampilan Pemrograman., firstline=82, lastline=91]{src/1174080.py}
	
	\item Jawaban soal No. 7
	\lstinputlisting[caption = Jawaban soal No. 7 Ketrampilan Pemrograman., firstline=93, lastline=102]{src/1174080.py}
	
	\item Jawaban soal No. 8
	\lstinputlisting[caption = Jawaban soal No. 8 Ketrampilan Pemrograman., firstline=104, lastline=112]{src/1174080.py}
	
	\item Jawaban soal No. 9
	\lstinputlisting[caption = Jawaban soal No. 9 Ketrampilan Pemrograman., firstline=114, lastline=121]{src/1174080.py}
	
	\item Jawaban soal No. 10
	\lstinputlisting[caption = Jawaban soal No. 10 Ketrampilan Pemrograman., firstline=123, lastline=140]{src/1174080.py}
	
	\item Jawaban soal No. 11
	\lstinputlisting[caption = Jawaban soal No. 11 Ketrampilan Pemrograman., firstline=10, lastline=40]{src/1174080(teori).py}
	
	\item Jawaban soal No. 12
	\lstinputlisting[caption = Jawaban soal No. 12 Ketrampilan Pemrograman., firstline=10, lastline=40]{src/1174080(teori).py}
