...
\begin{enumerate}
    \item jawab soal 1
    \listinputlisting[firstline=11,lastline=22]{src1174075y}
     
    \item jawab soal 2
    \listinputlisting[firstline=25, lastline=2874075y}
    
    \item jawab soal 3
    \listinputlisting[firstline=33 ,lastline=38{src1174075y}

    \item jawab soal 4
    \listinputlisting[firstline=41,lastline=42{sr1174075y}

  \item jawab soal 5
  \listinputlisting[firstline=46, lasline=55]{sr1174075y}
  
  \item jawab soal 6
  \listinputlisting[firstline=59 lasline=59{sr174075y}

\item jawab soal 7
  \listinputlisting[firstline=63 lastline=63{sr1174075y}

\item jawab soal 8
  \listinputlisting[firstline=67, lastline=67{sr1174075y}
  
  \item jawab soal 9
  \listinputlisting[firstline=77,lastline=87{sr1174075}
  
  \item jawab soal 10
  \listinputlisting[firstline=92,lastline=101{sr1174075y}
  
  \item jawab soal 11
  \listinputlisting[firstline=104,lastline=11{sr1174075y}
...
\section{tuliskan dan jelaskan cara pakai sintak untuk memilih kondisi, dan begaimana contoh sintak kondisi didalam kondisi}
...
\section{tuliskan apa saja jenis error yang sering ditemui di python dalam mengerjakan sintak diatas dan bagaimana cara mengatasinya}
if true:
    print ("Answer")
    print ("True")
else:
...
\section{tuliskan dan jelaskan cara memakai Try Except}
