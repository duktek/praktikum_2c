...
\begin{enumerate}
\item Jawaban Soal 1
\lstinputlisting[firstline=177, lastline=200]{src/1174066.py}
...
\subsection{Keterampilan Penaganan Error}
\begin{enumerate}
\item Jawaban Soal 
...
\subsection{Operator Dasar Aritmetika dan Cara Mengubah String ke Int Begitu Juga Sebaliknya}
...
\item jawaban soal 1
\lstinputlisting[firstline=11, lastline=22]{src/1174073.py}

\item jawaban soal 2
\lstinputlisting[firstline=25, lastline=30]{src/1174073.py}

\item jawaban soal 3
\lstinputlisting[firstline=33, lastline=38]{src/1174073.py}

\item jawaban soal 4
\lstinputlisting[firstline=41, lastline=42]{src/1174073.py}

\item jawaban soal 5
\lstinputlisting[firstline=46, lastline=55]{src/1174073.py}

\item jawab an soal 6
\lstinputlisting[firstline=59, lastline=59]{src/1174073.py}

\item jawaban soal 7
\lstinputlisting[firstline=63, lastline=63]{src/1174073.py}

\item jawaban soal 8
\lstinputlisting[firstline=67, lastline=73]{src/1174073.py}

\item jawaban soal 9
\lstinputlisting[firstline=77, lastline=87]{src/1174073.py}

\item jawaban soal 10
\lstinputlisting[firstline=92, lastline=101]{src/1174073.py}

\item jawaban soal 11
\lstinputlisting[firstline=104, lastline=11]{src/1174073.py}
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{sebutkan jenis-jenis variabel dan jelaskan cara pemakaian variabel tersebut dikode phyton} 
...
<type 'bool'>
\end{lstlisting}
\subsection{tuliskan bagaimana kode untuk meminta input dari user dan tuliskan bagaimana melakukan output ke layar}
\begin{lstlisting}
...
tanda % akan otomtis diganti dengan nilai yang kita inputkan ke variabel nama.
nama = raw_input("Inputakan nama: ")
umur = input("inputkan umur: ")
tinggi = input(inputkan tinggi badan: ")
print "Hello %5, saat ini usiamu %d tahun dan tinggi badanmu %f cm" % (nama, umur, tinggi)
\end{lstlisting}

\subsection{tuliskan operator dasar aritmatika, tambah, kali, kurang bagi, dan bagaimana mengubah string ke integer dan integer ke string}
\begin{lstlisting}
#penjumlahan
print(13-2)
apel=7
...
\subsection{tuliskan dan jelaskan sintak untuk perulangan, jenis-jenisnya contoh kode dan cara pakainya di phyton}
\begin{lstlisting}
...
\subsection{tuliskan dan jelaskan cara memakai Try Except}
\begin{lstlisting}
